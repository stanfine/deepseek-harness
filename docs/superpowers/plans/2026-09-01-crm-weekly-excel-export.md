...
**Reference:** [Agent Note](../../../.agents/notes/implemented/feature/2026-09-01-crm-weekly-excel-export.md)
...
3. Add `crm_export_weekly_excel` to `crm-tools.ts`, add the Host-owned `crm-excel-host.ts` provider and `/api/crm.export` route, and extend preset configuration with explicit renderer/export settings.
