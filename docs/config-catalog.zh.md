...
- `@deepseek-ai/dsh-client-ui-crm`（[`packages/client/ui-crm/src/index.ts`](../packages/client/ui-crm/src/index.ts)）
...
- `@deepseek-ai/dsh-crm-campaign`（[`packages/examples/crm-campaign/src/index.ts`](../packages/examples/crm-campaign/src/index.ts)）
